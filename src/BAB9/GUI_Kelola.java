...
private void checkRowSelected(int row) throws IllegalArgumentException {
    if (row == -1) {
        throw new IllegalArgumentException("Pilih baris terlebih dahulu.");
    }
    ...
    try {
        ...
        int option = JOptionPane.showConfirmDialog(this, "Apakah Anda yakin ingin menghapus baris ini?", "Konfirmasi Hapus", JOptionPane.YES_NO_OPTION);
