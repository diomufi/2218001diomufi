...
public class GUI_Catatan extends javax.swing.JFrame {
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        // call polymorphism impelementasi
        Cetakeluar ctk = new Cetakeluar();
        Catatan ctt = new Catatan();
        ctt.dataID(txt_id.getText());
        ctt.dataNama(txt_nama.getText());
        ctk.dataPengeluaran(txt_pengeluaran.getText());
        ...
        list.add(ctk.cetakPengeluaran());
        list.add(ctt.HargaBarangJasa());
